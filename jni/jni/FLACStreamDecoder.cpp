 ...
 * Constants
 **/
static char const * const FLACStreamDecoder_classname   = "edu.skku.monet.VoiceArchieving.FLAC.FLACStreamDecoder";
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_init(JNIEnv * env, jobject obj,
    jstring infile)
{
  assert(sizeof(jlong) >= sizeof(FLACStreamDecoder *));
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_deinit(JNIEnv * env, jobject obj)
{
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_read(JNIEnv * env, jobject obj,
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_bitsPerSample(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_channels(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_sampleRate(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_minBufferSize(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_totalSamples(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_seekTo(JNIEnv * env, jobject obj, jint sample)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamDecoder_position(JNIEnv * env, jobject obj)
{
  FLACStreamDecoder * decoder = get_decoder(env, obj);
