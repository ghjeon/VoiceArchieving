 ...
 * Constants
 **/
static char const * const FLACStreamEncoder_classname   = "edu.skku.monet.VoiceArchieving.FLAC.FLACStreamEncoder";
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_init(JNIEnv * env, jobject obj,
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_deinit(JNIEnv * env, jobject obj)
{
...
jint
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_write(JNIEnv * env, jobject obj,
...
void
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_flush(JNIEnv * env, jobject obj)
{
  FLACStreamEncoder * encoder = get_encoder(env, obj);
...
jfloat
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_getMaxAmplitude(JNIEnv * env, jobject obj)
{
  FLACStreamEncoder * encoder = get_encoder(env, obj);
...
jfloat
Java_edu_skku_monet_VoiceArchieving_FLAC_FLACStreamEncoder_getAverageAmplitude(JNIEnv * env, jobject obj)
{
  FLACStreamEncoder * encoder = get_encoder(env, obj);
